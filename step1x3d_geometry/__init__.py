...
# Importing these submodules registers the Mesh Motion VAE model, training
# system and data module via the @register decorators above.
from . import models, systems, datamodules
